...
LOCAL_LDLIBS += -llog 
LOCAL_CPP_FEATURES += rtti exceptions
LOCAL_CFLAGS += -I'D:/il2cpp/libil2cpp' -isystem 'extern' -I'extern/codegen/include' -DMODDEBUG='false' -DID='"RainbowMod"' -DVERSION='"0.2.0"' -I'./shared' -I'./extern' -Wno-inaccessible-base
